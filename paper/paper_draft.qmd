...
between reef characteristics and reefs' assigned categories were found to be similar at the
bioregion scale across GCMs. Results are only shown and discussed for ACCESS-ESM1-5, an
intermediate Equilibrium Climate Sensitivity scenario [@sfig-ecs]. Those interested in
results for the other assessed GCMs are referred to Grier and Iwanaga [-@grier2025]. Across
bioregions, reefs in the High category not only had greater levels of coral recovery but
displayed persistence to 2050 [@sfig-access-esm1-5-bioregion-timeseries]. Reefs in the High
category were consistently found to have the greatest median reef depths across bioregions
...
bioregions when comparing their temporal behaviour with respect to their reef area and mean
of DHWs (@sfig-access-esm1-5-bioregion-dhwmean). There were no consistent differences across
bioregions and GCMs between clusters in their reefs' initial proportion of habitable area
occupied by corals (@sfig-access-esm1-5-bioregion-initialproportion). Across most bioregions
there were not consistent differences between clusters in connectivity metrics such as
source-to-sink connectivity ratio (@sfig-access-esm1-5-bioregion-logsosi) and total
...
The assessed carbonate budget thresholds range from 10 to 20% of total reef area. Bracketed
x-axis values represent the Spearman's correlation between reef depth and the number of
years cover exceeds the carbonate budget threshold. Point colour represents the median reef
depth in metres. Red points represent the mean number of years above an assumed carbonate
budget threshold across reefs. Note that deeper reefs are better able to maintain cover
above the indicative carbonate budget threshold. Displays results from median time series
using
