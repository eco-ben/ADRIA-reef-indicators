...
assignment probability is roughly equal across the three clusters up to 6 DHW. A sharp
delineation can be seen \> 6 DHW when comparing High with other clusters, with lower
