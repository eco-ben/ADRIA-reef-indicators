...
unable to maintain coral cover above $\theta_0$ as the assumed threshold is increased, with
values **\[TI: Ben, could you clarify which values? Coral cover or years above
threshold?\]** becoming increasingly right-skewed. In contrast, log10-transformed total
...
[@sfig-access-esm1-5-conn-carbonate] **\[TI: Ben, because we are comparing depth and
connectivity, this figure needs to be shown in the main text\]**. The correlation between
$\text{log10}(S)$ and $\theta_0$ slightly decreases as the assumed threshold for $\theta_0$
increases.
