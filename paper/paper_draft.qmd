...
seeding, fragment devices and Crown of Thorns Starfish control, target reefs with suitable
...
reefs), 57% (991) of reefs fall into the low and medium clusters (across all GCMs at the
...
substantially. Additionally, two-way partial dependence analysis revealed that high incoming
connectivity is important for High cluster assignment for reefs at depths of \>10m.
Considering this 10-15m depth range, and targetting well connected reefs, when assessing
possible intervention sites may reduce the exposure of planted and seeded corals to high
thermal stress, while still maintaining effective logistical access to sites. Managers are
also likely to consider the positive potential for flow on effects due to outgoing
connectivity when selecting intervention sites [@hock2017]. Within the context of reef
depth, reefs with high depths and high outgoing connectivity levels had the greatest
probability of being clustered into high cover clusters
(@sfig-ts-cluster-pdp-twoway-outgoing). These results suggests that interventions targetting
deep reefs will also benefit from high incoming and outgoing connectivity levels, allowing
for high potential for site resilience and outgoing flow of benefits and recovery.
Transient, and difficult to measure, properties such as reef connectivity are likely to
increase uncertainty in intervention planning to a greater degree than environmental
characteristics such as reef depth. Overall, reef intervention planning is a complex and
challenging decision-making process [@anthony2020], and our results suggest that
intervention site depth may be an important factor to additionally consider when assessing
the long-term resilience of sites.
...
management region, green represents Cairns/Cooktown, red covers Townsville/Whitsunday and
blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are marked individually for
visual clarity. Darker colours represent higher probability of retaining spawned larvae
than lighter colours. All 2429 reefs included in this investigation are represented in this
figure. Annotations represent major coastal settlements along the
