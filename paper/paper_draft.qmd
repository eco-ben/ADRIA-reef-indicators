...
overview of the selected GCMs are provided in @tbl-gcms. Note here that Grose et al.,
...
from year to year within each simulation, they do vary between reefs which are of varying
sizes, providing sufficient heterogeneity to capture spatial patterns in larval dispersal
and settlement dynamics. The spatial variability also enables investigations into the
