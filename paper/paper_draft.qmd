...
management areas (@sfig-carb-budget-map; @sfig-depth-map). Additionally similar spatial
patterns were observed for reefs clustered into the high cover cluster category across all
GCMs (@sfig-gcm-cluster-map). We do not interpret these spatial findings as accurate
predictions of future resilience due to high uncertainty in input data, particularly depth
and connectivity. While similar findings have been demonstrated in the Pacific [@smith2014;
@baird2018] and Indo-Pacific [@bridge2014] regions, depth refugia analyses have often
focussed on the potential of mesophotic reefs (\> 30m deep) as thermal refugia
