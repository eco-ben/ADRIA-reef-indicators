...
connectivity (weighted incoming connectivity), outgoing connectivity (outgoing connection strength), the ratio of
source-to-sink connectivity, and larval retention probability for each reef. Weighted incoming connectivity is calculated by
summing the product of each connection strength incoming to a target reef and the mean
timeseries absolute coral cover (km^2^) of each matching source reef. This metric provides
an approximation of overall larval flow into a reef, with high values indicating the target
...
populations. A limitation of weighted incoming connectivity is it does not incorporate the
proportion of the source reef's population that is reproducing and producing larvae, instead
taking the total coral cover area as an indicator of larval productivity. Outgoing connection strength is calculated as the sum of all outgoing transition probabilities from a target reef. Outgoing connection strength has a theoretical maximum of one (all larvae reach settlement on sink reefs), however the large size of the GBR combined with larval mortality considerations result in outgoing connection strength values much lower than one. The ratio of
...
larval flow. Reef larval retention probability indicates the proportion of spawned larvae from a target reef that remain to settlement.
...
time series DHW, weighted incoming
connectivity, outgoing connection strength, ratio of source-to-sink larval connectivity, larval retention probability and reef carrying capacity (coral habitable
area).
...
Across bioregions there were no consistent patterns between reef clusters in mean DHW values (@sfig-access-esm1-5-bioregion-dhwmean), Log-10
weighted incoming connectivity (@sfig-access-esm1-5-bioregion-weightedincoming), Log-10 outgoing connection strength (@sfig-access-esm1-5-bioregion-outoingconn), Log-10
source-to-sink connectivity ratio (@sfig-access-esm1-5-bioregion-logsosi) and Log-10 larval retention probability (@sfig-access-esm1-5-bioregion-selfconn). Across six of the 29 bioregions reefs in the high cover cluster have lower Log-10
carrying capacity values than reefs in other
clusters (@sfig-access-esm1-5-bioregion-carrying-capacity).
...
(@fig-ts-cluster-pdp; Panel A). Reef median depth, mean DHW level and weighted incoming connectivity (Log10) have the highest
feature importance scores, accounting for 22%, 17% and 14% predictive importance respectively.
The carrying capacity of a reef accounts for 12% feature importance, while outgoing connection strength, source-to-sink ratio and larval retention account for 10%, 9% and 7% respectively.
...
Analyses for source-to-sink ratio and incoming and outgoing connectivity metrics
suggest that reefs with greater outgoing connectivity and lower incoming connectivity levels
have higher probability of being clustered into the Low cluster category compared to other
reefs. Additionally, two-way analyses revealed an interaction between reef depth and
incoming connectivity in determining cluster category assignment, particularly at the high
depth range (@fig-ts-cluster-pdp-twoway-incoming). Two-way analyses revealed that reefs at
greater than 10m depth are unlikely to be clustered into the Low cluster category,
regardless of their incoming connectivity levels. However, at greater than 10m depth reefs
with higher incoming connectivity are more likely to be assigned to a High cluster, while
reefs with low incoming connectivity are more likely to be assigned to a Medium cover
cluster (@fig-ts-cluster-pdp-twoway-incoming). Two-way analyses, for depth and outgoing connection strength, revealed a slight interaction with deep reefs with high outgoing connectivity having the greatest probability of being
clustered into a high cover cluster (@sfig-ts-cluster-pdp-twoway-outgoing).
...
intervention sites [@hock2017]. Within the context of reef depth, reefs
with high depths and high outgoing connectivity levels had the greatest probability of being
clustered into high cover clusters (@sfig-ts-cluster-pdp-twoway-outgoing). These results
suggests that interventions targetting deep reefs will also benefit from high incoming and
outgoing connectivity levels, allowing for high potential for site resilience and outgoing
flow of benefits and recovery. Transient, and difficult to measure, properties such as reef
...
![Map of the Great Barrier Reef region, including GBRMPA management areas (polygons) and all
considered reefs (points), coloured by median reef depth.
Colour-coded areas outline GBR marine park management regions, where orange represents the
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent greater reef depth values than darker colours. All 2429 reefs included in this
investigation are represented in this figure. Annotations represent major coastal
settlements along the GBR.](../figs/depth_med_input_map.png){#sfig-depth-map
fig-align="center" width="14.82cm"}
...
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent greater carrying capacity area values than darker colours. All 2429 reefs included in this
investigation are represented in this figure. Annotations represent major coastal
settlements along the GBR.](../figs/abs_k_area_input_map.png){#sfig-abs-k-area-map
fig-align="center" width="14.82cm"}

![Map of the Great Barrier Reef region, including GBRMPA management areas (polygons) and all
considered reefs (points), coloured by outgoing connection strength (Log10).
Colour-coded areas outline GBR marine park management regions, where orange represents the
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent higher outgoing connection strength values than darker colours. All 2429 reefs included in this
investigation are represented in this figure. Annotations represent major coastal
settlements along the GBR.](../figs/log_out_strength_input_map.png){#sfig-outgoing-conn-map
fig-align="center" width="14.82cm"}
...
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent higher source-to-sink values than darker colours. Source-to-sink ratio values above zero (one on normal scale) indicate a reef has greater outgoing than incoming connectivity. All 2429 reefs included in this
investigation are represented in this figure. Annotations represent major coastal
settlements along the GBR.](../figs/log_so_to_si_input_map.png){#sfig-sotosi-conn-map
fig-align="center" width="14.82cm"}

![Map of the Great Barrier Reef region, including GBRMPA management areas (polygons) and all
considered reefs (points), coloured by larval retention probability (Log10).
Colour-coded areas outline GBR marine park management regions, where orange represents the
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent higher probability of retaining spawned larvae than darker colours. All 2429 reefs included in this
investigation are represented in this figure. Annotations represent major coastal
settlements along the GBR.](../figs/log_self_strength_input_map.png){#sfig-self-conn-map
fig-align="center" width="14.82cm"}
...
![Map of the Great Barrier Reef region, including GBRMPA management areas (polygons) and all
considered reefs (points), coloured by median number of years exceeding positive carbonate budget threshold.
Colour-coded areas outline GBR marine park management regions, where orange represents the
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Reefs that have a median positive carbonate budget year value of 0 years are coloured in grey. All other reefs are coloured according to their median years across threshold values, with lighter colours representing greater number of years with positive carbonate budgets than darker colours. All 2429 reefs included in this
investigation are represented in this figure. This map depicts values from the ACCESS-ESM1-5 GCM. Annotations represent major coastal
settlements along the GBR.](../figs/ACCESS-ESM1-5/median_carbonate_budget_map.png){#sfig-carb-budget-map
fig-align="center" width="14.82cm"}

![Map of the Great Barrier Reef region, including GBRMPA management areas (polygons) and all
considered reefs (points), coloured by mean time series DHW value.
Colour-coded areas outline GBR marine park management regions, where orange represents the
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent higher mean DHW values than darker colours. All 2429 reefs included in this
investigation are represented in this figure. This map depicts values from the ACCESS-ESM1-5 GCM. Annotations represent major coastal
settlements along the GBR.](../figs/ACCESS-ESM1-5/mean_dhw_input_map.png){#sfig-mean-dhw-map
fig-align="center" width="14.82cm"}
...
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent higher weighted incoming connectivity values than darker colours. All 2429 reefs included in this
investigation are represented in this figure. This map depicts values from the ACCESS-ESM1-5 GCM. Annotations represent major coastal
settlements along the GBR.](../figs/ACCESS-ESM1-5/weighted_incoming_conn_input_map.png){#sfig-incoming-conn-map
fig-align="center" width="14.82cm"}