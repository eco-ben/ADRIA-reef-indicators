...
(@sfig-access-esm1-5-bioregion-outoingconn), Log-10 source-to-sink connectivity ratio
...
(@fig-access-esm1-5-carb-budget-corr).
...
experienced and exhibit overall similar DHW time series. While these reefs experience
similar magnitude DHWs based on SST, the proportion of the reefs' coral population impacted
by heat stress events depends on reef depth. Reefs at deeper depths are likely to be
clustered into High cover clusters. Reefs at shallow depths experience no, or few, years
with coral cover exceeding levels likely required to maintain positive carbonate budgets.
...
reef frameworks [@dudgeon2010; @perry2008]. Reefs at increased depths may be able to
...
positive carbonate budgets under future conditions. Spatially our results indicate that
...
ACCESS-ESM1-5 (@sfig-mean-dhw-map). Similar spatial patterns were observed across GCMs for
reefs clustered into the high cover cluster category (@sfig-gcm-cluster-map). We do not
...
Additionally, we do not incorporate the light-based decreases in coral growth rates as depth
...
deployment of coral seeding and fragment devices, target reefs with suitable sites in the
1-10m depth range [@howlett2021; @randall2021; @whitman2024]. While there are no explicit
justifications for this depth range, intervention depth is likely constrained by snorkelling
and diving deployment and monitoring logistical accessibility, visual identification of
sites from the surface, in combination with tourism return value. Our results suggest that
of the assessed reefs occurring within the 1-10m depth range (1736 reefs), 57% (991) of
reefs fall into the low and medium clusters (across all GCMs at the GBRMPA management region
scale), with many unable to maintain positive carbonate budgets under future conditions.
Partial dependence analysis revealed a range of depths from 10-15m where the probability of
a reef being clustered into the High cover cluster increased substantially. Additionally,
two-way partial dependence analysis revealed that high incoming connectivity is important
for High cluster assignment for reefs at depths of \>10m. Considering this 10-15m depth
range, and targetting well connected reefs, when assessing possible intervention sites may
reduce the exposure of planted and seeded corals to high thermal stress, while still
maintaining effective logistical access to sites. Managers are also likely to consider the
positive potential for flow on effects due to outgoing connectivity when selecting
intervention sites [@hock2017]. Within the context of reef depth, reefs with high depths and
high outgoing connectivity levels had the greatest probability of being clustered into high
cover clusters (@sfig-ts-cluster-pdp-twoway-outgoing). These results suggests that
interventions targetting deep reefs will also benefit from high incoming and outgoing
...
may be too high for juveniles to contribute to long term recovery. While there is
...
influential factors such as depth. In-depth comparisons and validation of multiple
...
two GCMs (@stbl-cluster-cid; @fig-gcm-cover-trajectories). Maintenance of coral cover into
...
Lighter colours represent greater reef depth values than darker colours. All 2429 reefs
...
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent greater carrying capacity
area values than darker colours. All 2429 reefs included in this investigation are
represented in this figure. Annotations represent major coastal settlements along the
...
visual clarity. Lighter colours represent higher outgoing connection strength values than
darker colours. All 2429 reefs included in this investigation are represented in this
...
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent higher source-to-sink
values than darker colours. Source-to-sink ratio values above zero (one on normal scale)
...
management region, green represents Cairns/Cooktown, red covers Townsville/Whitsunday and
blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are marked individually for
visual clarity. Lighter colours represent higher probability of retaining spawned larvae
than darker colours. All 2429 reefs included in this investigation are represented in this
figure. Annotations represent major coastal settlements along the
...
for each cluster and bands represent the distribution of connectivity values within each
cluster. Displays results for ACCESS-ESM1-5
GCM.](../figs/ACCESS-ESM1-5/bioregion/outgoing_strength_conn_bioregion_violin.png){#sfig-access-esm1-5-bioregion-outgoingconn
fig-align="center" width="14.82cm"}
...
their median years across threshold values, with lighter colours representing greater number
of years with positive carbonate budgets than darker colours. All 2429 reefs included in
...
management region, green represents Cairns/Cooktown, red covers Townsville/Whitsunday and
blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are marked individually for
visual clarity. Lighter colours represent higher mean DHW values than darker colours. All
...
Far Northern management region, green represents Cairns/Cooktown, red covers
Townsville/Whitsunday and blue covers Mackay/Capricorn [@GBRMPA2007]. Reef centroids are
marked individually for visual clarity. Lighter colours represent higher weighted incoming
connectivity values than darker colours. All 2429 reefs included in this investigation are
